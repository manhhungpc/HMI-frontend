...
<nav role="navigation">
	<ul class="main">
		...
		<li class="update"><a href="#">Add Book</a></li>
		<li class="update"><a href="#">Update Book</a></li>
		<li class="delete"><a href="#">Delete Book</a></li>
...
nav[role="navigation"] .delete a:before {
  content: "";
}
nav[role="navigation"] .update a:before {
  content: "";
}
nav[role="navigation"] .comments a:before {
  content: "";
}
nav[role="navigation"] .home a:before {
  content: "";
}
